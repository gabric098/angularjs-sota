 ...
 *
 * <pre>
 *   sotaAppDev = angular.module('sotaAppDev', ['sotaApp', 'ngMockE2E']);
 *   sotaAppDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('sotaApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('sotaApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('sotaApplicationModule'));
   *
   *
